...
- **Recording pill overlay** — while recording, paused or processing, a small Handy-style pill sits in the bottom-right corner just above the taskbar: status dot, elapsed time, pause/resume and stop buttons. Click it to reopen the full window, or drag it anywhere you like. On by default; opt out in Settings → General
